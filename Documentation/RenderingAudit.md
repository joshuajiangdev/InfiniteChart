...
The original combined PR #4 is superseded by this stack. Each code PR contains
one commit relative to the previous branch; the first starts directly at `main`.
Merge in this order, then retarget/restack the next PR onto `main` after its parent
lands. The documentation PR follows the axis PR and introduces no runtime changes.

| Order | Responsibility | macOS tests at that branch |
| --- | --- | --- |
| 1 | [Use unit-independent affine chart coordinates](https://github.com/joshuajiangdev/InfiniteChart/pull/5) | 35 passed |
| 2 | [Preserve viewport state across loading and layout](https://github.com/joshuajiangdev/InfiniteChart/pull/6) | 38 passed |
| 3 | [Default optional provider hooks for simpler consumers](https://github.com/joshuajiangdev/InfiniteChart/pull/7) | 39 passed |
| 4 | [Render provider-defined samples and handle invalid values](https://github.com/joshuajiangdev/InfiniteChart/pull/8) | 45 passed |
| 5 | [Compose built-in drawing inside the plot bounds](https://github.com/joshuajiangdev/InfiniteChart/pull/9) | 47 passed |
| 6 | [Make axis ticks and layout safe and configurable](https://github.com/joshuajiangdev/InfiniteChart/pull/10) | 51 passed |
| 7 | Architecture and audit documentation (this change) | Same code as step 6 |

The combined library sources exactly match the original audited implementation.
