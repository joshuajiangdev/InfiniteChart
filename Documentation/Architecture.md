...
Assessment of `main` at `42dcb0e` and its rendering audit at `fedf666`.
Only that main-based work is considered; proposed APIs below are not implemented.
...
- [ChartBaseView](../Sources/InfiniteChart/Components/ChartBaseView.swift) handles
  plot gestures. Axis views restrict their gestures to the corresponding dimension.
